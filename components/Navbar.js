    ...
    <div className="relative">
      <form onSubmit={handleSubmit}>
        ...
        <svg
          ...
          className="absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-500 px-3.5 peer-focus:border-primary-main peer-focus:stroke-primary-main"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="2"
